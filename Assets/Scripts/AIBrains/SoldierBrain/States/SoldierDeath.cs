...
{
    public class SoldierDeath  : IState, IReleasePoolObject
    {
        private Animator _soldierAnimator;
        private SoldierAIBrain _soldierAIBrain;
        private NavMeshAgent _navMeshAgent;
        private PoolType poolType;
        public SoldierDeath(SoldierAIBrain soldierAIBrain, Animator soldierAnimator,NavMeshAgent navMeshAgent)
        {
